...
INSERT INTO "new_Pokemon" ("attack", "defense", "hp", "id", "image", "name", "nickname", "order", "pokemonId", "special_attack", "special_defense", "speed", "teamId") SELECT "attack", "defense", "hp", "id", "image", "name", "nickname", "order", "pokemonId", "special_attack", "special_defense", "speed", "teamId" FROM "Pokemon";
DROP TABLE "Pokemon";
